...
> ① 먼저 Text Data를 TF-IDF, LDA, Doc2vec 3가지 알고리즘에 대해 적용한다.
...
> ② 각각의 Classfication Model을 구현한 뒤, Labeled Data를 활용해 Unlabeled Data의 Label을 예측한다.
>>[Predict Unlabeled Data]![2](https://user-images.githubusercontent.com/46133856/50424943-b5ddf780-08b0-11e9-83c4-8bee62af0e8e.JPG)
>>(강필성 교수님 Lecture Note 5강 pp59~16 참고)

****

> ③ 높은 confidence를 가지는 Data는 Label을 그대로 남기고 나머지 Data는 다시 1~3 과정 반복하며 Label을 달아준다.
